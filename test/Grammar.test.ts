...
// 本家 skynovel_esm/test/Grammar.test.ts をそのまま移植したもの。
//	トークナイザ（字句解析）は本家と完全に同じ挙動であることを保証したいため、
//	試作の都合で削るのではなく、テストごと丸移植して全て通す方針とする
...
import {creCFG, type SEARCH_PATH_ARG_EXT} from '../src/sn/ConfigBase';
