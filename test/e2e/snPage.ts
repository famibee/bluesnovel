...
export type T_PRJ = 'anime' | 'argdef' | 'autoskip' | 'autostory' | 'basic' | 'btnpic' | 'button' | 'chstyle' | 'event' | 'expr' | 'filter' | 'frame' | 'grp' | 'lay' | 'log' | 'movie' | 'multi' | 'page' | 'pic' | 'quake' | 'ruby' | 'save' | 'snap' | 'snd' | 'sys' | 'trans' | 'tsy' | 'wait';
