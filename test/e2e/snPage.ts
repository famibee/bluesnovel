...
export type T_PRJ = 'anime' | 'argdef' | 'autoskip' | 'autostory' | 'basic' | 'btnpic' | 'button' | 'chstyle' | 'choutstyle' | 'crypto' | 'derive' | 'event' | 'expr' | 'filter' | 'frame' | 'fx' | 'grp' | 'kinsoku' | 'lay' | 'log' | 'movie' | 'mulev' | 'multi' | 'page' | 'pic' | 'plg' | 'quake' | 'resize' | 'ruby' | 'save' | 'snap' | 'snd' | 'sys' | 'trans' | 'transflash' | 'tsy' | 'uc' | 'wait';
