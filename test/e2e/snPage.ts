...
export type T_WAIT = {nm: string; kind: 'l' | 'p' | 'waitclick'; noMark?: true} | null;
...
export type T_PRJ = 'anime' | 'argdef' | 'autoskip' | 'autostory' | 'basic' | 'btnhover' | 'btnpic' | 'button' | 'chstyle' | 'choutstyle' | 'crypto' | 'derive' | 'dumpscript' | 'event' | 'expr' | 'filter' | 'frame' | 'fx' | 'grp' | 'kinsoku' | 'kinperf' | 'lay' | 'log' | 'movie' | 'mulev' | 'multi' | 'page' | 'pic' | 'plg' | 'quake' | 'resize' | 'ruby' | 'save' | 'snap' | 'snd' | 'sys' | 'trans' | 'transflash' | 'tsy' | 'txtbox' | 'uc' | 'wait';
