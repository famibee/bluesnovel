...
export type T_PRJ = 'anime' | 'argdef' | 'autoskip' | 'autostory' | 'basic' | 'button' | 'chstyle' | 'event' | 'expr' | 'filter' | 'frame' | 'grp' | 'lay' | 'multi' | 'pic' | 'quake' | 'ruby' | 'save' | 'snap' | 'sys' | 'trans' | 'tsy' | 'wait';
