...
// 本家 skynovel_esm/test/RubySpliter.test.ts をそのまま移植したもの。
//	ルビ記法の解釈は本家と完全に同じであることを保証したいので、テストごと丸移植して全て通す方針。
//	相違は T_PutCh の import 元だけ（本家 CmnInterface.ts は持たないので移植先に置いた）

import {RubySpliter, type T_PutCh} from '../src/sn/RubySpliter';
