...
var a = class {
	...
	async load(e) {
		e.window ??= {
			width: 300,
			height: 300
		}, n.stageW = e.window.width, n.stageH = e.window.height, n.debugLog = e.debug.debugLog, n.masume = e.debug.masume, n.init(), await super.load(e), n.bgColor = t(this.oCfg.init.bg_color);
	}
