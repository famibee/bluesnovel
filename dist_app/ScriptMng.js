...
var yo = class p {
	...
	constructor(e) {
		this.sys = e, this.#m = new n(e, ""), this.#w = new oe((t, n) => e.cfg.searchPath(t, n), (t, n) => e.fetch(t, n), (t, n) => e.dec(t, n), (t) => e.decAB(t), e.crypto), this.#e = document.createElement("span"), this.#e.hidden = !0, this.#e.textContent = "", this.#e.style.cssText = `	z-index: ${2 ** 53 - 1};
			...
			color: black;
			background-color: rgba(255, 255, 255, 0.7);`, document.body.appendChild(this.#e), this.#t.trace = (e) => this.#at(e), this.#t.log = (e) => this.#st(e, this.#r?.fn ?? "", this.#r?.lineNum ?? NaN);
	}
	destroy() {
	...
	#y;
	async #b(e) {
		return this.#n[e] ??= new S(e, await this.#it(e), this.#S());
	}
	#x;
	#S() {
		...
		if (e) {
			...
			try {
				for (;;) {
					...
					if (n?.t !== "loadScript") {
						e.atEnd ? this.myTrace(`スクリプト終端です fn:${e.fn}`, "I") : this.#nt();
						return;
					}
					try {
	...
	async #Ve() {
		...
		for (let [n, r] of [[e, "fore"], [t, "back"]]) for (let e of n) if (a(e)) {
			if (e.fn) {
	...
	#nt() {
		...
		if (e) for (let t of new Set(e.peekUpcomingPicFn())) {
			...
			this.#tt.has(e) || this.#tt.set(e, this.#Ze(e));
		}
	}
	#rt(e) {
		switch (e.t) {
			...
			case "chgPic": {
				...
				let s = (e) => {
					let t = this.#tt.get(e);
					return t && this.#tt.delete(e), t ?? this.#Ze(e);
				};
			...
			case "chgBPic":
				this.$fncs.chgBPic({
					...
					page: e.page,
					fn: e.fn,
					src: e.fn ? this.#Ye("lay b_pic", e.fn) : ""
				});
				break;
			case "chgBackClear":
			...
			case "trace":
				...
				break;
			case "log":
				this.#st({ text: e.text }, e.fn, e.lineNum);
				break;
