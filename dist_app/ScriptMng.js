...
var Ua = class p {
	...
	#y;
	async #b(e) {
		return this.#n[e] ??= new S(e, await this.#lt(e), this.#S());
	}
	#x;
	#S() {
	...
	#ct(e) {
		switch (e.t) {
			...
			case "layPlg": break;
			case "chgPic": {
				let t = this.#Qe("lay", e.fn), { isSheet: n, isMovie: r } = Ha(t), i = e.aFace?.map((e) => {
