...
async function Ce(e, t, n) {
	...
	let r = Se[/\.([a-z0-9]+)$/i.exec(e)?.[1]?.toLowerCase() ?? ""];
	if (!r) return e;
...
var we = class e {
	...
	#v;
	async #y(e) {
		return this.#n[e] ??= new k(e, await this.#ze(e), this.#x());
	}
	#b;
	#x() {
	...
	#Ie(e) {
		return Ce(e, this.sys.fetch, (e) => this.sys.decAB(e));
	}
	#Le = /* @__PURE__ */ new Map();
	#Re(e) {
		switch (e.t) {
...
//#endregion
export { we as ScriptMng, Ce as decryptPicUrl };
