...
var yo = class p {
	...
	#y;
	async #b(e) {
		return this.#n[e] ??= new S(e, await this.#ot(e), this.#S());
	}
	#x;
	#S() {
	...
	#at(e) {
		switch (e.t) {
			...
			case "layPlg": break;
			case "chgPic": {
				let t = this.#Xe("lay", e.fn), { isSheet: n, isMovie: r } = vo(t), i = e.aFace?.map((e) => {
			...
			case "stop": {
				...
				this.#P = e.kind === "s", e.resume ? this.#V(e.resume.mode, e.resume.msec) : this.$fncs.setSkipping(!1), this.#_(), this.$fncs.setBackAlpha(Number(this.#r?.getVal("sys:TextLayer.Back.Alpha") ?? 1)), this.$fncs.setBtnFont(String(this.#r?.getVal("tmp:sn.button.fontFamily") ?? "") || c), this.#r && this.$fncs.setChWait(this.#r.chWait);
				break;
			}
		}
	}
