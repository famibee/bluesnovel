...
var ye = 999e3, be = class {
	...
	#v;
	async #y(e) {
		return this.#n[e] ??= new k(e, await this.#He(e), this.#x());
	}
	#b;
	#x() {
	...
	async #Ae(e) {
		...
		let n = e.fn.startsWith(g), r = n ? e.fn : ce(e.fn || "snapshot"), a = se(r), { stageW: o, stageH: s } = i, c = e.width || o, l = e.height || s, u = (e.aLayNm === null && e.page === "fore" && e.b_color === void 0 ? await this.sys.capturePage(this.#je(t), c, l, a) : "") || await ue({
			el: t,
			sw: o,
			sh: s,
			width: c,
