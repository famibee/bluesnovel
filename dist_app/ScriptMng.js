...
var co = class p {
	...
	#_e(e, t, n) {
		let r = this.#ue.filter((n) => p.#ve(n, e, t));
		if (r.length === 0) {
			setTimeout(() => this.#j(), 0);
			return;
		}
	...
	async #Je(e) {
		...
		let r = e.fn.startsWith(f), i = r ? e.fn : te(e.fn || "snapshot"), a = T(i), { stageW: o, stageH: s } = t, c = e.width || o, l = e.height || s, u = (e.aLayNm === null && e.page === "fore" && e.b_color === void 0 ? await this.sys.capturePage(this.#Ye(n), c, l, a) : "") || await C({
			el: n,
			sw: o,
			sh: s,
			width: c,
	...
	#at(e) {
		switch (e.t) {
			...
			case "autowc":
				...
				break;
			case "clearLay":
				this.#ce(e.aLayNm, e.page), this.#ge((t) => (e.page === "both" || t.page === "both" || t.page === e.page) && p.#ve(t, e.aLayNm, null)), this.$fncs.clearLay({
					aLayNm: e.aLayNm,
					page: e.page
