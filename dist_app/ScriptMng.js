...
var co = class p {
	...
	#y;
	async #b(e) {
		return this.#n[e] ??= new x(e, await this.#Xe(e), this.#S());
	}
	#x;
	#S() {
	...
	async #Re(e) {
		...
		let r = e.fn.startsWith(f), i = r ? e.fn : te(e.fn || "snapshot"), a = T(i), { stageW: o, stageH: s } = t, c = e.width || o, l = e.height || s, u = (e.aLayNm === null && e.page === "fore" && e.b_color === void 0 ? await this.sys.capturePage(this.#ze(n), c, l, a) : "") || await C({
			el: n,
			sw: o,
			sh: s,
			width: c,
	...
	#He(e) {
		...
		return this.#Ve[e] ??= this.sys.cfg.matchPath(`^${t}$`, d.SP_GSM).length > 0 ? this.sys.cfg.searchPath(t, d.SP_GSM) : "";
	}
	#Ue(e, t) {
		if (!t) return "";
