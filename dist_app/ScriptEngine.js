...
var ce = class e {
	...
	#ee(t, n, r, i = !1) {
		let s = t.layer ?? "", c = this.#w[s] ?? "txt", l = c !== "grp" && c !== "txt";
		if (!l) {
			let e = t.fn || t.pic;
			if (e) {
				let i = {
	...
	#ne(t, i, l) {
		...
		switch (t) {
			...
			case "tsy": {
				...
				let n = this.skipEnabled, r = n ? 0 : e.#n("tsy", "time", i.time ?? ""), a = n ? 0 : e.#i("tsy", "delay", i.delay, 0), s = e.#i("tsy", "repeat", i.repeat, 1), c = e.argPage(i, "fore");
			...
			case "endlink": {
				let { nm: t, page: n } = this.#le(i);
				return this.#ue(l, e.#ce("endlink", {}), !0, t, n), "skip";
			}
			case "graph": {
				if (!i.pic) throw "[graph] picは必須です";
				let { nm: t, page: n } = this.#le(i);
				return this.#ue(l, e.#ce("grp", {
					...i,
					layer: void 0,
					page: void 0
				}), !0, t, n), "skip";
			...
			case "ch": {
				...
				return this.#ue(l, e.#ce("add", {
					...i,
					text: void 0,
					layer: void 0,
					page: void 0
				}) + n.replaceAll("[r]", "\n") + e.#ce("add_close", {}), i.record !== "false", r, a), "skip";
			}
			case "autowc": {
				...
				if (this.#k.setNochk("save:const.sn.autowc.text", n ?? ""), !n) return this.#k.setNochk("save:const.sn.autowc.time", ""), l.push({
					t: "autowc",
					enabled: t,
					hWait: {}
				}), "skip";
			...
			case "ch_in_style":
			case "ch_out_style": {
				let e = t === "ch_in_style" ? "in" : "out", { name: n, sty: r } = s(t, i, e === "in");
				if (this.#P[e].has(n)) throw `[${t}] name【${n}】はすでにあります`;
				return this.#P[e].add(n), l.push({
					t: "defChStyle",
					kind: e,
					nm: n,
					sty: r
			...
			case "window": {
				...
				}, n = (e) => Number(this.#k.get(`tmp:const.sn.config.window.${e}`) ?? 0), r = (t, n, r) => i[t] === void 0 ? i[n] === void 0 ? r : e.#n("window", n, i[n]) : e.#n("window", t, i[t]), a = {
			...
			case "clear_text": {
				...
				return t === this.#v && n === "fore" && this.#de(), this.#x(n)[t] = "", l.push({
					t: "chgStr",
					nm: t,
					page: n,
					str: ""
			...
			case "xchgbuf": {
				...
				let s = this.#T[t], c = this.#T[n];
				return c === void 0 ? delete this.#T[t] : this.#T[t] = c, s === void 0 ? delete this.#T[n] : this.#T[n] = s, this.#k.setNochk("save:const.sn.loopPlaying", JSON.stringify(this.#T)), l.push({
					t: "xchgBufSnd",
					buf: t,
					buf2: n
				}), "skip";
			...
			case "volume": {
				...
				let a = Number(this.#k.get(`save:${n}volume`, 1, !0));
				return l.push({
					t: "volumeSnd",
					buf: t,
					volume: a * r
