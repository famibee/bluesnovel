...
var se = class e {
	...
	#se(n, i, a) {
		...
		switch (n) {
			...
			case "span": {
				if (i.r_align !== void 0 && !q.includes(i.r_align)) throw `[span] r_alignの値が不正です：${i.r_align}`;
