import { a as y, p as w, b as _, u as b, c as r, i as g } from "./CmnLib.js";
import { PropParser as d } from "./PropParser.js";
class p {
...
class k {
  constructor(t, s) {
    if (this.cfg = t, s.let = (i) => this.#o(i), s.let_abs = (i) => this.#L(i), s.let_char_at = (i) => this.#F(i), s.let_index_of = (i) => this.#K(i), s.let_length = (i) => this.#R(i), s.let_replace = (i) => this.#P(i), s.let_round = (i) => this.#M(i), s.let_search = (i) => this.#x(i), s.let_substr = (i) => this.#D(i), s.clearsysvar = () => this.#c(), s.clearvar = () => this.#b(), s.dump_val = () => this.#I(), s.copybookmark = (i) => this.#O(i), s.erasebookmark = (i) => this.#j(i), this.#i["sn.userFnTail"] = "", this.defTmp("const.sn.bookmark.json", () => {
      const i = [];
    ...
    }), this.#t["const.sn.isFirstBoot"] = !0, this.#t["const.sn.last_page_text"] = "", this.#t["const.sn.last_page_plain_text"] = "", this.#t["const.sn.displayState"] = !1, this.#t["const.Date.getTime"] = () => (/* @__PURE__ */ new Date()).getTime(), this.#t["const.Date.getDateStr"] = () => y(), this.#t["const.sn.platform"] = JSON.stringify(w), this.#c(!0), this.#b(), this.#t["const.sn.config.window.width"] = t.oCfg.window.width, this.#t["const.sn.config.window.height"] = t.oCfg.window.height, this.#t["const.sn.config.book.title"] = t.oCfg.book.title, this.#t["const.sn.config.book.version"] = t.oCfg.book.version, this.#t["const.sn.Math.PI"] = Math.PI, this.#t["const.sn.isPaging"] = !1, typeof window > "u") return;
  ...
  async setSys(t) {
    this.#n = t, await t.initVal(this.#e, this.#t, (s) => {
      ...
      } : () => t.flush(), this.#g = (i, o) => t.callHook(i, o), t.addHook((i, o) => this.#W[i]?.(i, o));
  ...
  #W = {
    ...
    set_var: (t, s) => {
      try {
        this.#v(s.nm, s.val), this.#n.send2Dbg(s.ri, {});
      } catch {
      }
    },
    set_data_break: (t, s) => {
  ...
  #o(t) {
    ...
    return this.#v(t.name, t.text, s), !1;
  }
  // 絶対値
  #L(t) {
    const s = r(t, "text", 0);
  ...
  #D(t) {
    const s = r(t, "pos", 0);
    return t.text = t.len !== "all" ? (t.text ?? "").slice(s, s + g(r(t, "len", 1))) : (t.text ?? "").slice(s), this.#o(t), !1;
  }
  //	// デバッグ・その他
  // システム変数の全消去
  #c(t = !1) {
  ...
  // ゲーム変数の全消去
  #b() {
    const t = this.#i["const.sn.mesLayer"] ?? "", s = this.#i["sn.doRecLog"] ?? !1, e = this.#i["const.sn.sLog"] ?? "[]";
    return this.#i = this.#s.save = {}, this.setVal_Nochk("save", "const.sn.mesLayer", t), this.setVal_Nochk("save", "sn.doRecLog", s), this.setVal_Nochk("save", "const.sn.sLog", e), !1;
  }
  #v = (t, s, e = !0) => {
    if (!t) throw "[変数に値セット] nameは必須です";
    if (s == null) throw "[変数に値セット] textは必須です（空文字はOK）";
    const a = d.getValName(t);
  ...
  #S(t) {
    ...
    if (s !== "undefined")
      return this.#B.test(s) ? parseFloat(s) : t;
  }
  #B = /^-?[\d\.]+$/;
  // 変数のダンプ
  #I = () => {
  ...
  #N = {
    ...
    "sys:sn.tagCh.canskip": (t) => this.#m(t),
